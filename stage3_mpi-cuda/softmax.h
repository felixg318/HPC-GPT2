...
static inline void softmax_set_distributed(int rank, int world_size, int last_dim_sharded) {
    ...
    (void)g_softmax_rank;
    (void)g_softmax_world;
    (void)g_softmax_last_dim_sharded;
}
...
static inline void softmax_backward_2d(Tensor* t) {
    ...
    int used_cuda = 0;
#ifdef USE_CUDA
    used_cuda = cuda_softmax_2d_backward(y->data, y->grad, x->grad, N, C);
#endif
...
static inline void softmax_backward_3d(Tensor* t) {
    ...
    int used_cuda = 0;
#ifdef USE_CUDA
    used_cuda = cuda_softmax_3d_backward(y->data, y->grad, x->grad, B, T, C);
#endif
...
static inline void softmax_forward_2d(const Tensor* x, Tensor* y) {
    ...
    int used_cuda = 0;
#ifdef USE_CUDA
    used_cuda = cuda_softmax_2d(x->data, y->data, N, C);
#endif
...
static inline void softmax_forward_3d(const Tensor* x, Tensor* y) {
    ...
    int used_cuda = 0;
#ifdef USE_CUDA
    used_cuda = cuda_softmax_3d(x->data, y->data, B, T, C);
#endif
